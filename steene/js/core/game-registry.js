...
const baseGameRegistryData = [
  ...
  // ── ROADMAP — BOARD GAMES ──────────────────────────────
  { id: 'checkers', icon: '⚫', thumbnail: "https://tse4.mm.bing.net/th/id/OIP._jAJ-vnRk6XW5kKANnUM1QHaE0?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'board-games', route: null, players: '2', supportedModes: ['local', 'ai'], status: 'coming_soon' },
  { id: 'backgammon', icon: '🎲', thumbnail: "https://tse1.explicit.bing.net/th/id/OIP.iWxGw1fvGRroVPRLItrskQHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'board-games', route: null, players: '2', supportedModes: ['local', 'ai'], status: 'coming_soon' },
  { id: 'go', icon: '⚪', thumbnail: "https://tse4.mm.bing.net/th/id/OIP.0GGbbwfYd8W6-6avw51KZwHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'board-games', route: null, players: '2', supportedModes: ['local', 'ai'], status: 'coming_soon' },
  { id: 'reversi', icon: '🔴', thumbnail: "https://tse1.explicit.bing.net/th/id/OIP.fB4LNxD6PQxAiXe8vCmQbQHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'board-games', route: null, players: '2', supportedModes: ['local', 'ai'], status: 'coming_soon' },
  { id: 'ludo', icon: '🎯', thumbnail: "https://tse1.explicit.bing.net/th/id/OIP.mjcPCbx3J_n9pLOn3YGL6gHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'board-games', route: null, players: '2-4', supportedModes: ['local', 'ai'], status: 'coming_soon' },

  // ── ROADMAP — CARD GAMES ───────────────────────────────
  { id: 'poker', icon: '🃏', thumbnail: "https://tse3.mm.bing.net/th/id/OIP.8J6GtWe01i4434qOCpZEvwHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'card-games', route: null, players: '2-8', supportedModes: ['local', 'ai', 'online'], status: 'coming_soon' },
  { id: 'blackjack', icon: '🂡', thumbnail: "https://tse4.mm.bing.net/th/id/OIP.c3YWFwlTFJ7YxEZfcHuZRgHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'card-games', route: null, players: '1', supportedModes: ['ai'], status: 'coming_soon' },
  { id: 'solitaire', icon: '🂮', thumbnail: "https://th.bing.com/th/id/R.bc258e9b5c676081f00b771ecd876948?rik=bYsvobSIDz6q1w&pid=ImgRaw&r=0", category: 'card-games', route: null, players: '1', supportedModes: ['local'], status: 'coming_soon' },
  { id: 'spades', icon: '♠️', thumbnail: "https://tse4.mm.bing.net/th/id/OIP.u_UGK_IVQQPd38O5cFzOLAHaFO?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", category: 'card-games', route: null, players: '4', supportedModes: ['local', 'online'], status: 'coming_soon' },
